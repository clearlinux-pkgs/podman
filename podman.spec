...
Source0  : https://github.com/containers/podman/archive/v4.3.1/podman-4.3.1.tar.gz
...
%prep
%setup -q -n podman-4.3.1
cd %{_builddir}/podman-4.3.1
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677181633
